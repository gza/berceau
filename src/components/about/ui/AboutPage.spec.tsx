...
describe("AboutPage Component", () => {
  ...
  it("should render the description paragraph", () => {
    ...
    expect(screen.getByText(/the monobackend project demonstrates/i)).toBeInTheDocument()
    expect(screen.getByText(/modern web application architecture/i)).toBeInTheDocument()
  })
  ...
  it("should render the Architecture Principles section", () => {
    ...
    expect(screen.getByRole("heading", { name: /architecture principles/i })).toBeInTheDocument()
  })

  it("should render all architecture principles", () => {
    render(<AboutPage />)
    
    expect(screen.getByText("Service-oriented architecture")).toBeInTheDocument()
    ...
    expect(screen.getByText("Server-side rendering for performance")).toBeInTheDocument()
  })
