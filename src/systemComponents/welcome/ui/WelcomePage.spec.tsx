...
describe("WelcomePage Component", () => {
  ...
  it("should render the description paragraph", () => {
    ...
    expect(
      screen.getByText(/this is the main welcome page/i),
    ).toBeInTheDocument()
    expect(
      screen.getByText(/unified architecture with server-side rendering/i),
    ).toBeInTheDocument()
  })
  ...
  it("should render all feature list items", () => {
    ...
    expect(
      screen.getByText("Test-driven development approach"),
    ).toBeInTheDocument()
  })
